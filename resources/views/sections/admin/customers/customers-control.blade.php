<div class="w-full flex flex-wrap items-center justify-between gap-2">
    ...
    <div class="flex flex-wrap items-center gap-2 shrink-0">
        ...
        <div class="relative hidden lg:block">
            ...
            <select wire:model.live="filterEmailVerified" class="appearance-none bg-brand-100 border-none rounded-md py-2.5 pl-14 pr-10 text-[12px] font-bold text-brand-700 focus:ring-1 focus:ring-brand-500 outline-none cursor-pointer">
        ...
        <div class="relative hidden lg:block">
            ...
            <select wire:model.live="sortBy" class="appearance-none bg-brand-100 border-none rounded-md py-2.5 pl-16 pr-8 text-[12px] font-medium text-brand-700 focus:ring-1 focus:ring-brand-500 outline-none cursor-pointer">
