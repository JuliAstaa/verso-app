<div class="w-full flex flex-wrap items-center justify-between gap-2">
    ...
    <div class="flex flex-wrap items-center gap-2 shrink-0">
        ...
        <button class="flex items-center gap-2 bg-brand-100 text-brand-500 px-4 py-2.5 rounded-md text-sm font-medium hover:text-white hover:bg-brand-500 transition-all cursor-pointer">
