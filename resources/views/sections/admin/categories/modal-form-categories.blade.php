...
>
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden" x-click.away="$wire.set('isModalOpen', false)">
        ...
        <div class="px-8 pb-8 space-y-6">
            ...
            {{-- 1. Name Input --}}
            <div>
                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Category Name</label>
                <input 
                    wire:model="name" 
                    type="text" 
            ...
            {{-- 2. Image Input (SIMPLE VERSION) --}}
            <div>
                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1">Cover Image</label>
            ...
            <div class="flex items-center justify-between bg-gray-50 p-4 rounded-xl">
                <span class="text-xs font-bold text-gray-700 uppercase tracking-wider">Active Status</span>
