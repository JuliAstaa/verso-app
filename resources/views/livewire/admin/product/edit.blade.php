<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500">Update product details and manage variants.</p>
        </div>
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-3 gap-2 mb-4">
                    ...
                    @foreach($newImages as $img)
                        <div class="aspect-square rounded-lg overflow-hidden border-2 border-green-500 relative">
                            <img src="{{ $img->temporaryUrl() }}" class="w-full h-full object-cover opacity-80">
                            <span class="absolute bottom-0 w-full text-center text-[9px] bg-green-500 text-white font-bold py-0.5">NEW</span>
                        </div>
                    @endforeach
                    
                    {{-- 3. UPLOAD BUTTON (MANUAL ALPINE) --}}
                    <label 
                        ...
                        class="aspect-square flex flex-col items-center justify-center bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-100 relative overflow-hidden @error('newImages') border-red-500 bg-red-50 @enderror"
                    >
                ...
                <p class="text-[10px] text-gray-400">Click the red trash icon to remove old photos.</p>
            </div>
