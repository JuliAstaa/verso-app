...
<div x-data="{ showBackendError: {{ ($errors->any() || session('error')) ? 'true' : 'false' }} }" 
    ...
    {{-- Card Utama --}}
    <div class="bg-white w-full h-auto md:h-[90vh] max-w-[1200px] max-h-[750px] flex flex-col md:flex-row">
    ...
    <div x-show="showBackendError" 
        ...
        <div @click.away="showBackendError = false" 
            ...
            <h3 class="text-xl font-bold text-gray-800 mb-2">
                {{ session('error') ? 'Access Denied' : 'Registration Error' }}
            </h3>
            ...
            {{-- Menggunakan x-button solid --}}
            <x-button variant="solid" @click="showBackendError = false" class="w-full !py-4 !rounded-xl !no-underline">
                Understood
            </x-button>
        </div>
    </div>
