<div>
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        @foreach($products as $product)
            <div class="group bg-white rounded-lg overflow-hidden border border-transparent hover:border-gray-200 hover:shadow-lg transition-all duration-300 cursor-pointer">
                ...
                <div class="p-3">
                    ...
                    <p class="font-bold text-base mb-1">Rp{{ number_format($product['price'], 0, ',', '.') }}</p>
