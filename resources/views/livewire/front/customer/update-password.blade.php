<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden font-poppins">
    ...
    <div class="p-8">
        ...
        <form wire:submit.prevent="updatePassword" class="space-y-6 max-w-4xl">    
            {{-- Current Password --}}
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input wire:model="current_password" type="password" name="current_password" placeholder="••••••••"
                ...
                @error('current_password') 
                    <span class="text-xs text-red-500 font-bold block ml-1">{{ $message }}</span> 
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input wire:model="password" type="password" name="new_password" placeholder="New password (min. 6 chars)"
                               class="w-full pl-12 pr-4 py-3 bg-gray-50/50 border border-gray-100 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all">
                    </div>
                    @error('password') 
                        <span class="text-xs text-red-500 font-bold block ml-1">{{ $message }}</span> 
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input wire:model="password_confirmation" type="password" name="new_password_confirmation" placeholder="Re-type new password"
                               class="w-full pl-12 pr-4 py-3 bg-gray-50/50 border border-gray-100 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all">
                    </div>
                </div>
            </div>
